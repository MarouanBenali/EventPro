 ...
 * Permet aux Organisers de créer un nouvel événement
 */
const CreateEvent = () => {
  ...
  // Categorys disponibles pour les Event
  const categories = [
    "Technology",
    "Business",
    "Marketing",
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!formData.title.trim()) newErrors.title = "Title requis";
    if (!formData.description.trim())
      newErrors.description = "Description requise";
    if (!formData.category) newErrors.category = "Category requise";
    if (!formData.date) newErrors.date = "Date requise";
    if (!formData.time) newErrors.time = "Time requise";
    if (!formData.location.trim()) newErrors.location = "Localisation requis";
    if (!formData.maxParticipants || formData.maxParticipants < 1) {
      newErrors.maxParticipants = "Nombre de participants invalide";
    }
    if (formData.price < 0) newErrors.price = "Price invalide";
  ...
  // Vérification des droits d'Organiser
  if (user?.role !== "organizer" && user?.role !== "admin") {
    return (
      <div className="container error-container">
        <div className="alert error">
          Vous devez être Organiser pour créer des Event
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="create-event-container">
      ...
      <header className="ev-header">
        ...
        <p>Share your passion with the world</p>
      </header>

      {/* Messages d'état */}
      <div className="status-messages">
        {success && (
          <div className="alert success">Événement créé avec succès !</div>
        )}
      ...
      <div className="form-grid">
        ...
        <main className="form-column">
          <form onSubmit={handleSubmit} className="event-form">
            {/* Section Base informations */}
            <section className="form-section">
              <h2>
                <FaCalendarAlt /> Base informations
              </h2>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  >
                    <option value="">Sélectionnez une Category</option>
            ...
            {/* Section Localisation and capacity */}
            <section className="form-section">
              <h2>
                <FaMapMarkerAlt /> Localisation and capacity
              </h2>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <div className="input-with-icon">
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="Localisation physique ou lien en ligne"
            ...
            <div className="form-actions">
              ...
              >
                <FaSave /> {loadingSubmit ? "Publication..." : "Publish"}
              </button>
            </div>
          </form>
        </main>
          ...
          {formData.title ? (
            <>
              ...
              <div className="preview-details">
                ...
                <p>
                  <FaMapMarkerAlt /> {formData.location || "Non spécifié"}
                </p>
                <p>
                  <FaUsers /> {formData.maxParticipants || "Non défini"}{" "}
                  participants max
                </p>
                <p>
                  <FaMoneyBillAlt />{" "}
                  {formData.price > 0 ? `${formData.price}€` : "Gratuit"}
                </p>
              </div>
            ...
            <div className="empty-preview">
              You can see the event preview here
            </div>
          )}
        </aside>
      </div>
